...
import { usePathname, useRouter } from 'next/navigation'; // 2. Import usePathname and useRouter
...
function LogoutButton() {
  ...
  return (
    <button
      ...
      className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#272d3a] transition-colors"
    >
